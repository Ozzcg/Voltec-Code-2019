...
public class RobotMap {
	...
	/*
	 * public static WPI_VictorSPX liftMain; public static WPI_VictorSPX
	 * liftFollower;
	 */
	...
	public static double gyroP = 0.03; // Hay que ajustar.
	...
	public static void init() {
		...
		/*
		 * liftMain = new WPI_TalonSRX(VICTOR_LIFT_MOTOR_ENCODER_PORT); liftFollower =
		 * new WPI_TalonSRX(VICTOR_LIFT_MOTOR_FOLLOWER_PORT);
		 */
