...
public class OI {
	...
	public Button rightJoystickLeft;
	public Button rightJoystickRight;
	...
	public OI() {
		...
		/* rightJoystickLeft = buttonFromAxis(joystick1, 2, true);
		rightJoystickRight = buttonFromAxis(joystick1, 2, false); */
		...
		/* rightJoystickLeft.whenPressed(new AlignNext(true));
		rightJoystickRight.whenPressed(new AlignNext(false)); */
		Button12.whileHeld(new GyroAlign());
	...
	private Button buttonFromAxis(GenericHID controller, int rawAxis, boolean toLeft) {
		return new Button() {
			@Override
			public boolean get() {
				return toLeft ? (controller.getRawAxis(rawAxis)) < 0 : (controller.getRawAxis(rawAxis)) > 0;
			}
		};
	}
}